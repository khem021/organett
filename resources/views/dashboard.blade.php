...
<div class="grid-4">
    ...
    <a href="{{ route('batches.index') }}" class="stat-card">
    ...
    <a href="{{ route('harvest.index') }}" class="stat-card">
        <div class="stat-header">
    ...
    <a href="{{ route('inventory.index', ['filter' => 'low']) }}" class="stat-card">
        <div class="stat-header">
    ...
    <div style="display:flex;flex-direction:column;gap:1rem;">
        ...
        <div class="card">
            ...
            <div style="display:flex;flex-direction:column;gap:.5rem;">
                <a href="{{ route('batches.index') }}" class="quick-action">
                ...
                <a href="{{ route('harvest.index') }}" class="quick-action">
